...
@section('content')
    <div class="subheader flex-wrap">
        <div class="subheader-left pt-2 pb-2">
            <h3 class="subheader-left-title">{{__('Edit Transfer')}}</h3>
            ...
            <div class="subheader-breadcrumbs">
                ...
                <span class="breadcrumbs-separator-dot"></span>
                <a href="{{route('transfers.edit', $transfer->id)}}" class="breadcrumbs-link">{{__('Edit Transfer')}}</a>
            </div>
        </div>
    </div>
        ...
        <div class="card mb-4">
            <div class="card-header">
                <div class="card-title">
                    <h3 class="card-label">{{__('Edit Transfer')}}</h3>
                </div>
