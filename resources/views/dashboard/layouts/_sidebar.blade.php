<div id="simple-bar" class="simple-bar">
    <ul class="menu-nav" id="menu-nav">
        ...
        <li class="menu-item-group">{{__('DATA')}}</li>
        <li class="menu-item">
        ...
        <li class="menu-item">
            <a href="{{route('hotels.index')}}" class="menu-link">
                <span class="menu-text">{{__('Hotels')}}</span>
            </a>
        </li>
        <li class="menu-item">
            <a href="{{route('meeting_rooms.index')}}" class="menu-link">
                <span class="menu-text">{{__('Meeting Rooms')}}</span>
            </a>
        </li>
        <li class="menu-item">
            <a href="{{route('companies.index')}}" class="menu-link">
                <span class="menu-text">{{__('Companies')}}</span>
            </a>
        </li>
        <li class="menu-item">
            <a href="{{route('company_types.index')}}" class="menu-link">
                <span class="menu-text">{{__('Company Types')}}</span>
            </a>
        </li>
        <li class="menu-item">
        ...
        <li class="menu-item">
            <a href="{{route('destinations.index')}}" class="menu-link">
                <span class="menu-text">{{__('Destinations')}}</span>
            </a>
        </li>
        <li class="menu-item">
        ...
        <li class="menu-item">
            <a href="{{route('extra_services.index')}}" class="menu-link">
                <span class="menu-text">{{__('Extra Services')}}</span>
            </a>
        </li>
        <li class="menu-item">
            <a href="{{route('extra_service_types.index')}}" class="menu-link">
                <span class="menu-text">{{__('Extra Service Types')}}</span>
            </a>
        </li>
        <li class="menu-item">
        ...
        <li class="menu-item">
            <a href="{{route('package_types.index')}}" class="menu-link">
                <span class="menu-text">{{__('Package Types')}}</span>
            </a>
        </li>
        <li class="menu-item">
            <a href="{{route('transfers.index')}}" class="menu-link">
                <span class="menu-text">{{__('Transfers')}}</span>
            </a>
        </li>
        <li class="menu-item">
            <a href="{{route('data.upload')}}" class="menu-link">
                <span class="menu-text">Bulk Insert</span>
            </a>
        </li>
        <li class="menu-item-group">{{__('Settings')}}</li>
        <li class="menu-item">
                ...
                <ul class="menu-nav">
                    ...
                    <li class="menu-item">
                        <a href="{{route('translation_manager')}}" class="menu-link">
                            ...
                            <span class="menu-text">{{__('Translation Manager')}}</span>
                        </a>
                    </li>
                </ul>
            </div>
