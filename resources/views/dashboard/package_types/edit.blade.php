...
@section('content')
    <div class="subheader flex-wrap">
        <div class="subheader-left pt-2 pb-2">
            <h3 class="subheader-left-title">{{__('Edit Package Type')}}</h3>
            ...
            <div class="subheader-breadcrumbs">
                ...
                <span class="breadcrumbs-separator-dot"></span>
                <a href="{{route('package_types.edit', $package_type->id)}}" class="breadcrumbs-link">{{__('Edit Package Type')}}</a>
            </div>
        </div>
    </div>
        ...
        <div class="card mb-4">
            <div class="card-header">
                <div class="card-title">
                    <h3 class="card-label">{{__('Edit Package Type')}}</h3>
                </div>
            </div>
            <div class="card-body">
                {!! Form::model($package_type, [
                        'method' => 'PATCH',
                        'route' => [ "package_types.update", $package_type->id]
                     ]) !!}
                @include('dashboard.package_types.parts._form')
