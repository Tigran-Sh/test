...
@section('content')
    <div class="subheader flex-wrap">
        <div class="subheader-left pt-2 pb-2">
            <h3 class="subheader-left-title">{{__('Destinations')}}</h3>
        ...
        <div class="card mb-4">
            <div class="card-header">
                <div class="card-title">
                    <h3 class="card-label">{{__('Destinations')}}</h3>
                </div>

                <div class="ml-auto">
                    <a href="{{route('destinations.create')}}" class="btn btn-create">
            ...
            <div class="card-body">
                ...
                <div class="d-flex align-items-end justify-content-between flex-wrap">
                    <form action="{{route('destinations.index')}}" class="ml-auto mb-4">
                ...
                <div class="table-responsive">
                    <table class="table mobile-table">
                        ...
                        <tr>
                            ...
                            <th>@sortablelink('region.name', __('Region'))</th>
                        ...
                        <tr>
                            ...
                            <td class="table-buttons">
                                <div class="text-center table-buttons">
                                    <a href="{{route('destinations.show', $destination->id)}}" class="btn" title="{{__('Show details')}}">
                                        <i class="flaticon-eye"></i>
                                    </a>
                                    <a href="{{route('destinations.edit', $destination->id)}}" class="btn" title="{{__('Edit details')}}">
                                        <i class="flaticon-edit"></i>
                                    </a>
                                    <a href="#" class="btn" title="{{__('Delete')}}" onclick="$(this).next().submit()">
                                        <i class="flaticon2-trash"></i>
                                    </a>
                                    <form action="{{route('destinations.destroy', $destination->id)}}" method="POST" onsubmit="return confirm('{{__('Are You Sure?')}}')">
                                        @csrf
                                        @method('DELETE')
                                    </form>
                                </div>
