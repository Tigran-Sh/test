...
@section('content')
    <div class="subheader flex-wrap">
        <div class="subheader-left pt-2 pb-2">
            <h3 class="subheader-left-title">{{__('Create User')}}</h3>
            ...
            <div class="subheader-breadcrumbs">
                ...
                <span class="breadcrumbs-separator-dot"></span>
                <a href="{{route('users.create')}}" class="breadcrumbs-link">{{__('Create User')}}</a>
            </div>
        </div>
    </div>
        ...
        <div class="card mb-4">
            <div class="card-header">
                <div class="card-title">
                    <h3 class="card-label">{{__('Create User')}}</h3>
                </div>
            </div>
            <div class="card-body">
                {!! Form::open(['route' => "users.store"]) !!}
                @include('dashboard.users.parts._form')
